...
--		{	down = tedac_commands.LHG_TADS_FOV_SW_W,				up = tedac_commands.LHG_TADS_FOV_SW_W,					cockpit_device_id = devices.TEDAC_INPUT,	value_down =  1.0,	value_up = 0.0,		name = _('CPG2PLT_LHG TADS FOV Switch - W (Wide)'),								category = {_('TEDAC_CPG2PLT'), _('Left Handgrip')}},
		{	down = tedac_commands.LHG_TADS_FOV_SW_Z,				up = tedac_commands.LHG_TADS_FOV_SW_Z,					cockpit_device_id = devices.TEDAC,		value_down =  1.0,	value_up = 0.0,		name = _('CPG2PLT_LHG TADS FOV Switch - Z (Zoom)'),								category = {_('TEDAC_CPG2PLT'), _('Left Handgrip')}},
		{	down = tedac_commands.LHG_TADS_FOV_SW_M,				up = tedac_commands.LHG_TADS_FOV_SW_M,					cockpit_device_id = devices.TEDAC,		value_down = -1.0,	value_up = 0.0,		name = _('CPG2PLT_LHG TADS FOV Switch - M (Medium)'),							category = {_('TEDAC_CPG2PLT'), _('Left Handgrip')}},
		{	down = tedac_commands.LHG_TADS_FOV_SW_N,				up = tedac_commands.LHG_TADS_FOV_SW_N,					cockpit_device_id = devices.TEDAC,		value_down = -1.0,	value_up = 0.0,		name = _('CPG2PLT_LHG TADS FOV Switch - N (Narrow)'),							category = {_('TEDAC_CPG2PLT'), _('Left Handgrip')}},
		{	down = tedac_commands.LHG_TADS_FOV_SW_W,				up = tedac_commands.LHG_TADS_FOV_SW_W,					cockpit_device_id = devices.TEDAC,		value_down =  1.0,	value_up = 0.0,		name = _('CPG2PLT_LHG TADS FOV Switch - W (Wide)'),								category = {_('TEDAC_CPG2PLT'), _('Left Handgrip')}},
...
--		{	down = tedac_commands.LHG_TADS_SENSOR_SELECT_SW_FLIR,															cockpit_device_id = devices.TEDAC_INPUT,	value_down =  1.0,						name = _('CPG2PLT_LHG TADS Sensor Select Switch - FLIR'),						category = {_('TEDAC_CPG2PLT'), _('Left Handgrip')}},
--		{	down = tedac_commands.LHG_TADS_SENSOR_SELECT_SW_TV,																cockpit_device_id = devices.TEDAC,	value_down =  0.0,						name = _('CPG2PLT_LHG TADS Sensor Select Switch - TV'),							category = {_('TEDAC_CPG2PLT'), _('Left Handgrip')}},
		{	down = tedac_commands.LHG_TADS_SENSOR_SELECT_SW_DVO,															cockpit_device_id = devices.TEDAC,	value_down = -1.0,						name = _('CPG2PLT_LHG TADS Sensor Select Switch - DVO'),						category = {_('TEDAC_CPG2PLT'), _('Left Handgrip')}},
...
--		{	down = tedac_commands.RHG_LRFD_TRIGGER,					up = tedac_commands.RHG_LRFD_TRIGGER,					cockpit_device_id = devices.TEDAC_INPUT,	value_down =  1.0,	value_up = 0.0,		name = _('CPG2PLT_RHG LRFD Trigger - SECOND DETENT'),							category = {_('TEDAC_CPG2PLT'), _('Right Handgrip')}},
		{	down = tedac_commands.RHG_LRFD_TRIGGER,					up = tedac_commands.RHG_LRFD_TRIGGER,					cockpit_device_id = devices.TEDAC,		value_down =  0.5,	value_up = 0.0,		name = _('CPG2PLT_RHG LRFD Trigger - FIRST DETENT'),							category = {_('TEDAC_CPG2PLT'), _('Right Handgrip')}},
		{	down = tedac_commands.RHG_LRFD_TRIGGER,					up = tedac_commands.RHG_LRFD_TRIGGER,					cockpit_device_id = devices.TEDAC,		value_down =  1.0,	value_up = 0.0,		name = _('CPG2PLT_RHG LRFD Trigger - SECOND DETENT'),							category = {_('TEDAC_CPG2PLT'), _('Right Handgrip')}},
